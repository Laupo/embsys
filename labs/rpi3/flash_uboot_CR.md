...
**Question 1**: Une fois le flashage terminé, combien y-a t-il de partition
                ...
                Il y en a 2, la première contient le rootfile system et la deuxième contient le kernet et les fichiers de configuration du boot.
...
**Question 2**: Lire la
                ...
                Les ports TX et RX sont les ports GPIO14 et GPIO15.
