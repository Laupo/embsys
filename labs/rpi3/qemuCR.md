...
**Question 1**: À quoi sert l'option *--cap-add* lors du lancement d'un
                ...
                Cette option permet d'ajouter des autorisations au docker
...
la commande *chroot* permet de gagner en privilèges nécessaires pour pouvoir exécuter busybox.

Ensuite, exécutez le binaire cross-compilé *hw* dans l'environnement *chroot*.

**Question 3**: Que se passe-t-il? Pourquoi?

Hello World ! S'affiche à l'écran car on a simulé un environnement ARM correspondant à la cross-compilation.
